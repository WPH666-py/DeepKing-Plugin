# -*- coding: utf-8 -*-
"""生成 Deepseek-Skin-Suit20 仓库。

模板: _suit20-src/tpl/(取自 Suit12 的"单张样式"套件)
特点: IMAGE_FILES 只有 1 张素材 -> grid = 全屏单图(cover), single1 = 卡片单图。
脚本与文档都按 Suit20 显式写出(不再靠对上一套做链式替换, 避免文案串味)。

用法: python _suit20-src/gen_suit20.py
...
ASSET_STEM = "01-village"
WALLPAPER_NAME = "苗寨灯火(16:9 宽幅)"
PET_NAME = "苗寨灯火"
# 桌宠: 取人物区域(方形取景; 夜景插画无白底可抠)
PET_CROP = (0.70, 0.62, 0.46)        # (中心x比例, 中心y比例, 半边长占最短边比例)
BG_TOL = 26
BG_BRIGHT = 168
